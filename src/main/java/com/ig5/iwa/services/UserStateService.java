...
public class UserStateService {
    ...
    public Optional<Integer> getIdStateOfUserState(int id_user){
        return userStateRepository.findTopById_IdUserOrderByDateDesc(id_user).map(User_State::getState).map(State::getId_state);
    }
